...
import com.javaproject.qeats.exceptions.ItemNotFromSameRestaurantException;
import com.javaproject.qeats.exceptions.UserNotFoundException;
...
public interface CartAndOrderService {
     ...
     */
    CartModifiedResponse addItemToCart(String itemId, String cartId, String restaurantId, String userId)
